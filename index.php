...
<body>
  ...
  <div class="collapse navbar-collapse justify-content-end bg-primary mt-1" id="navbarNav">
    <div class="d-flex">
      <button class="btn btn-light me-2 log-btn nav-button" onclick="location.href='#login'">Login</button>
      <button class="btn btn-light reg-btn nav-button" onclick="location.href='#register'">Register</button>
    </div>
  </div> -->
  ...
  <nav class="navbar  navbar-expand-md">
    <div class="container-fluid">
      ...
      <button class="btn btn-light  log-btn nav-button" href="#">Login</button>
      <button class="btn btn-light reg-btn nav-button" href="#">Register</button>
    </div>
  </nav>
  ...
  <div class="nav-buttons">
    <div class="collapse position-absolute top-35 end-0 translate-end-x  shadow  p-3" id="navbarToggleExternalContent3"
      ...
      <button class="btn btn-light me-2 log-btn" onclick="location.href='#login'">Login</button>
      <button class="btn btn-light reg-btn" onclick="location.href='#register'">Register</button>
    </div>
  </div>
